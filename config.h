...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,	XK_x,		spawn,		SHCMD("dmenu_input.sh -a") },
	/* { MODKEY,		XK_y,		,		{} */
	...
	{ MODKEY|ShiftMask,	XK_Delete,	spawn,		SHCMD("$TERMINAL_LITE -e htop") },
	{ MODKEY|ControlMask,	XK_Delete,	spawn,		SHCMD("xkill") },
